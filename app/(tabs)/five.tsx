...
export default function ChatPage() {
  ...
  return (
    <ImageBackground
      source={require("../images/chatbg.jpg")}
      ...
      >
        ...
        <View style={styles.inputContainer}>
          <TextInput
            ...
            onSubmitEditing={sendMessage} // Call sendMessage when Enter key is pressed
            returnKeyType="send" // Change the return key to a send button
          />
